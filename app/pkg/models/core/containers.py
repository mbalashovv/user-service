...
class Containers:
    ...
    def set_environment(
        ...
        *,
        pkg_name: Optional[StrictStr] = None,
        testing: bool = False,
        database_configuration_path: StrictStr = "POSTGRES_DATABASE_NAME",
        prefix: Optional[StrictStr] = "test_",
    ) -> None:
    ...
    def __patch_container_configuration(
        container: Container,
        database_configuration_path: StrictStr,
        prefix: StrictStr,
        ...
        pydantic_settings.POSTGRES_DSN = pydantic_settings.POSTGRES_DSN.replace(
            database_name,
            prefix + database_name,
        )
